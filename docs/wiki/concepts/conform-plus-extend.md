...
- **extensions slot (#453)** in [[../topics/cq-interop-and-schema]]: the `additionalProperties:false` blocker was resolved upstream; extensions now travel as `stolperfalle:<field>` keys instead of being stripped.
